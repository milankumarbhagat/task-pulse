...
The project has multiple build configurations available. The build artifacts will be stored in the `dist/` directory.

- `npm run build:dev` - Builds the project using the development environment configuration.
- `npm run build:prod` - Builds the project using the production environment configuration for deployment.
